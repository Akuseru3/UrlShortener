...
var urlCards = document.getElementsByClassName('card card-top shadow-sm p-3 mb-5 bg-white rounded');
var urlButtons = document.getElementsByClassName('link-button');

var _loop = function _loop(index) {
  $(urlButtons[index]).on('click', function () {
    var nfsw = urlCards[index].getElementsByClassName("btn btn-danger");
    var shortUrl = urlButtons[index].textContent;
...
for (var index = 0; index < urlButtons.length; index++) {
  _loop(index);
}
